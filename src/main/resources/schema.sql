DROP TABLE IF EXISTS users, friendship, genre, mpa_rating, film, film_genres, film_likes, directors, film_directors, review_likes, reviews, user_feed CASCADE;
